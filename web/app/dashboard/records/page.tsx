                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredRecords.length > 0 ? (
                    filteredRecords.map(record => (
                      <tr key={record.id}>
                        <td style={{ width: '9rem' }} className="px-6 py-4 whitespace-nowrap text-base text-center">
                          {format(new Date(record.recordedDate), 'yyyy-MM-dd')}
                        </td>
                        <td style={{ width: '11rem' }} className="px-6 py-4 whitespace-nowrap text-base text-center">
                          {record.student 
                        ...
                        <td style={{ maxWidth: '28rem', width: '40%' }} className="px-6 py-4 text-base text-center truncate">
                          {record.memo}
                        </td>
                        <td style={{ width: '8rem' }} className="px-6 py-4 whitespace-nowrap text-base text-center">
                          {record.serverSynced ? (
                        ...
                        <td style={{ width: '7rem' }} className="px-6 py-4 whitespace-nowrap text-base text-center">
